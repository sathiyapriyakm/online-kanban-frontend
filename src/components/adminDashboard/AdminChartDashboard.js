...
export function AdminChartDashboard({userData}) {
    let data2=[];
    const [barChartData,setBarChartData]=useState(null);
    const [chartData,setChartData]=useState(null);
    const data1=[
        {Source:"Total Tasks",value:userData.totalTasks},
        {Source:"In-Progress Tasks",value:userData.inProgress},
    ...
    const setChart=()=>{  
        let data=[
          ...
          {task:"NotStarted",count:userData.notStarted},
          {task:"BlockedTask",count:userData.bpTasks},
        {task:"InProgress",count:userData.inProgress},
...
<div className="col-xl-4 col-lg-5">
    <div className="card shadow mb-4">
        ...
        <div className="mt-4 text-center small">
                ...
                <span className="mr-2">
                    <i className="fas fa-circle text-success" title ="In-Progress Tasks">In-Progress Tasks</i>
                </span>
                <span className="mr-2">
